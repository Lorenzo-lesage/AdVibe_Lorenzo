<div>
    <form class="shadow rounded p-md-5 p-4 pb-md-3 pb-3 mb-lg-0 mb-5 bg-2-op" wire:submit="store">
        <div class="mb-3">
            <label for="title" class="form-label mb-0">{{ __('ui.title') }}:</label>
        ...
        <div class="mb-3">
            <label for="description" class="form-label mb-0">{{ __('ui.description') }}:</label>
        ...
        <div class="mb-3">
            <label for="price" class="form-label mb-0">{{ __('ui.price') }}:</label>
        ...
        {{-- IMMAGINI --}}
        <div class="mb-3">
            <label for="category" class="form-label mb-0">{{ __('ui.category') }}:</label>
        ...
        <div class="mb-3">
            <label for="temporary_images"
                ...
                {{ __('ui.image') }}: <span class="fst-italic text-muted">{{ __('ui.max_images') }}</span>
            </label>
        ...
        <div class="d-flex justify-content-center">
            <button type="submit" class="btn btn-custom2 fw-bold">{{ __('ui.publish_ad') }}</button>
        </div>
    </form>
</div>
